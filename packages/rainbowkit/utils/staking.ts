import { type StakingScripts, stakingTransaction } from "@babylonlabs-io/btc-staking-ts";
import type { networks, Transaction } from "bitcoinjs-lib";

import type { UTXO, WalletProvider } from "../providers/wallet_provider";
import { isTaproot } from "./index";

import { apiDataToStakingScripts } from "./apiDataToStakingScripts";
import { txFeeSafetyCheck } from "./fee";
import { getStakingTerm, type GlobalParamsVersion } from "./getStakingTerm";
import { signPsbtTransaction } from "./psbt";

interface StakingTxResult {
  unsignedStakingPsbt: any;
  stakingTerm: number;
